...
def _compute_missing_citations(
    conn: duckdb.DuckDBPyConnection,
    db_path: Path,
    xuid: str,
    shared_alias: str,
) -> dict[str, int]:
    """Calcule et stocke les citations pour les matchs non encore traités."""
...
def backfill_citations_for_player(
    ...
    *,
    ...
    with ctx as conn:
        ...
        try:
            return _compute_missing_citations(conn, db_path, xuid, shared_alias)
        finally:
            import contextlib
