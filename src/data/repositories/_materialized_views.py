"""Mixin – write/refresh des vues matérialisées player (stats.duckdb).

Contient les méthodes de création et de rafraîchissement :
- _ensure_mv_tables
- refresh_materialized_views + _rebuild_global_stats
- _refresh_session_stats + _partial_refresh_session_stats
- _refresh_mv_map_stats + _refresh_mv_mode_category_stats

Les méthodes de lecture (get_map_stats, get_session_stats, etc.) sont
dans _mv_queries.py → MaterializedViewsQueryMixin.
"""
