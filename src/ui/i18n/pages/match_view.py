...
STRINGS: dict[str, dict[str, str] | str] = {
    ...
    # Section armes / outils de destruction
    "mv_weapon_kills_title": {"fr": "Outils de destruction", "en": "Tools of destruction"},
