...
STRINGS: dict[str, dict[str, str] | str] = {
    ...
    "media_filter_auteur": {"fr": "Auteur", "en": "Author"},
    ...
    "media_sort_desc": {"fr": "↓", "en": "↓"},
    "media_sort_asc": {"fr": "↑", "en": "↑"},
    "media_sort_order": {"fr": "Ordre", "en": "Order"},
    "media_group_by": {"fr": "Grouper par", "en": "Group by"},
    "media_group_by_short": {"fr": "Groupe", "en": "Group"},
    "media_sort_by_short": {"fr": "Tri", "en": "Sort"},
    "media_group_none": {"fr": "(Aucun)", "en": "(None)"},
    "media_group_author": {"fr": "Auteur", "en": "Author"},
    "media_group_date": {"fr": "Date", "en": "Date"},
    "media_group_map": {"fr": "Carte", "en": "Map"},
    "media_group_mode": {"fr": "Mode", "en": "Mode"},
    "media_group_session": {"fr": "Session", "en": "Session"},
    "media_group_experience": {"fr": "Solo · Escouade", "en": "Solo · Squad"},
    "media_experience_solo": {"fr": "Solo", "en": "Solo"},
    "media_experience_squad": {"fr": "Escouade", "en": "Squad"},
    "media_group_liked": {"fr": "Aimés", "en": "Liked"},
    "media_liked_yes": {"fr": "Aimé", "en": "Liked"},
    "media_liked_no": {"fr": "Non aimé", "en": "Not liked"},
    "media_sort_date_capture": {"fr": "Date", "en": "Date"},
    ...
    # ── Options lightbox ────────────────────────────────────────────────────
    "ml_autoplay_videos": {"fr": "Avance auto", "en": "Auto-advance"},
    "ml_autoplay_videos_help": {
        "fr": "Passe automatiquement au média suivant à la fin d'une vidéo.",
        "en": "Automatically advance to the next media item when a video ends.",
    },
    # ── Settings ────────────────────────────────────────────────────────────
}
