"""
Port — interface structurelle pour tout client API Halo Infinite.
...
les consommateurs importent d'ici pour éviter une dépendance directe
sur src.data.sync (couche adaptateur).
"""
