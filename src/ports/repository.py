"""
Port — interface structurelle pour les repositories de données.
...
Seule implémentation active : DuckDBRepository (src/data/repositories/).

Ce fichier fait partie de la couche ports (architecture hexagonale) :
les consommateurs (app/, ui/, analysis/) importent d'ici pour éviter
une dépendance directe sur la couche data/.
"""
