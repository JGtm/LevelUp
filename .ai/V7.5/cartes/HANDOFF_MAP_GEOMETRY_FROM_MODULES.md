...
> établie, et elle est consignée dans **`.ai/V7.5/cartes/HANDOFF_GEOMETRIE_TRIANGLES.md`**. Ce document-ci
...
des armes, encodé de manière typique »). Sources : `../killweapon/HANDOFF_KILLFEED_VOIE_A.md`, `../killweapon/WALK_PORT_NOTES.md`.
...
**Doc détaillé : `.ai/V7.5/cartes/INVESTIGATION_MAP_ZONE_CALLOUT_NAMES.md`.**
