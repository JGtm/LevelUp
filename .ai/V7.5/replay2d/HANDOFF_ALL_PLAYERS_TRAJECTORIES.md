...
> `../film_re/HANDOFF_KEYFRAME_LIVE_CAPTURE.md` (framing keyframe résolu).
...
- Fixture : `.ai/V7.5/dumps/allbipeds_capture_sample.txt` (2000 records ; format
...
4. **Objectif 2 (kill feed) — DÉJÀ RÉSOLU AILLEURS + impasse dead-state re-confirmée.**
   ...
   prod (`internal/sync/backfill_weapons.go`, cf `../killweapon/PLAN_WEAPON_PER_KILL_PRODUCTION.md`). Ma
   ...
   **DÉBLOCAGE 2026-07-04 (CE, film joué) — le kill-event same-clock est LOCALISÉ** (cf mémoire
   ...
   250 events `.ai/V7.5/dumps/killevents_sample.txt` : DMG portent tous `42c9679f` (arme, §169),
