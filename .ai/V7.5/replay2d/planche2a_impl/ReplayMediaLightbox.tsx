/**
 * DESTINATION : apps/web/src/features/match-replay/ReplayMediaLightbox.tsx
 *
...
import { clipFrameCount, type ReplayMediaItem } from './replayTimelineTracks'
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isClip ? (
          <video src={item.url} controls autoPlay className="w-full rounded bg-black" />
        ) : (
