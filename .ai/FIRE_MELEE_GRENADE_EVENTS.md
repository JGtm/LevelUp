...
> ⭐⭐⭐ **2026-06-12 — ARME À FEU PAR KILL RÉSOLUE *OFFLINE* & SCALABLE → voir `.ai/FIREARM_PER_KILL_OFFLINE_SOLVED.md`.**
...
documentées ci-dessous pour reprise éventuelle. Récap des stats exploitables : `.ai/RECAP_STATS_EXPLOITABLES.md`.
