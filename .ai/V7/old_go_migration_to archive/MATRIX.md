...
> Lire aussi [PLAN_MIGRATION_PYTHON_TO_GO.md](PLAN_MIGRATION_PYTHON_TO_GO.md), [OPS_COMPAT_CHECKLIST.md](OPS_COMPAT_CHECKLIST.md) et [GO_MIGRATION_CHECKLIST.md](GO_MIGRATION_CHECKLIST.md).
