...
**MAJ 2026-06-23** : item 1 tranché (115 = design autoritaire) + item 3 LIVRÉ (front title-aware). Reste 2 (P80) + 4 (KDA/assist), tous deux activation/data-couplés.
...
2. **P80 par titre** (`OffensiveConversionP80=0.90`/`DefensiveResistanceP80=1.65` recalibrés Infinite, `combat_yield.go:48-51` ; + `0.83`/`1.59` milestones post-sync) : recalibrer sur échantillon Halo 5 OU dégrader « non calibré ». **Besoin échantillon live.** (Non bloquant : h5 stats not_exposed Phase 1.)
