...
> ⭐ **TOURNANT 2026-06-07 — LIRE `.ai/FIRE_MELEE_GRENADE_EVENTS.md` D'ABORD.** La conclusion « pas
...
> Consolide : `KILLFEED_RE_FINDINGS.md` (RE mécanisme), `HANDOFF_FRAME_DECODER_L3.md` (décodeur),
> `PLAN_FILM_KILLFEED_V3.md` + `PLAN_FILM_ECS_DECODER.md` (archi), `HANDOFF_FILM_RE_STATE.md` (handoff externe),
...
> Détail complet : **`.ai/DBG_CAPTURE_dmg_record.md`** (registres, bitreader, message 214 o, pile). À NE PAS PERDRE.
...
en secours** (capture d'event en jeu au besoin — `go_blocking` + bp opérationnels, cf `.ai/DBG_CAPTURE_dmg_record.md`).
