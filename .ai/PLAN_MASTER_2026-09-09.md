...
| 2.5 | E5 bloc partagé + Synthèse ; E6 Escouade | Sonnet, effort élevé (Go de E5 : Opus effort bas) | gates E5, E6 | [ ] en cours 09-09 (soir) : deux exécutants en parallèle, fichiers disjoints — Go E5.4-E5.7 + E6.1 (Opus, worktree `LevelUp-wt-equipement-e5-go`, branche `feat/equipement-e5-go` depuis `b369c15c8`) et extraction web E5.1-E5.3 + scissions `usageLogic.ts` / `equipmentUsageLogic.ts` (Sonnet, `feat/equipement-gachis`). Puis E5.8-E5.13 et E6.2-E6.5 (web) après fusion des deux |
