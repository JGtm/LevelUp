...
| 3.R | Revue UNIQUE si 3.3 exécutée ; sinon delivery-checklist seule | — | — | [ ] en cours 10-09 : un relecteur Sonnet en contexte frais sur 3.1 + 3.2 (`git diff 1cfbf9cea feat/v75` hors fonds WebP, déjà relus) ; `make gate-push` en parallèle |
