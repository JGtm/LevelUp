...
| 5.5 | Correctif E0 n° 5 (décision utilisateur 10-09 soir) : « utilisé » des déployables SANS pièce engendrée (capteur, traqueur, écran occultant, champ de réparation, translocateur…) lu sur les consommations `spent` (`usageUsedOf` sur `SpentByFamily`) et non sur les poses `deployed`, qui ne coïncident jamais avec une consommation hors mur (0/202) ; le mur garde ses panneaux. Bump `UsageSummaryRev` us6, garde-rail des familles, `REFERENCE_CANAUX_EQUIPEMENT` mise à jour ; re-résumé par le superviseur (2 s) | Opus, worktree `LevelUp-wt-usage-us6` (`wt/usage-us6`) | tests usage_summary + golden, intégration `-p 1` persist, lint 0 ; après re-résumé : capteur et traqueur « utilisés » cohérents avec leurs consommations | [ ] |
| 5.6 | Correctifs E0 n° 2 + 3 (décision utilisateur 10-09 soir) : classement de palette « pureté ≥ 90 % si n ≥ 10, unanimité si n < 10 » (7 films purs famille A classés, 0 mal classé sur 64, `4f77afc1` reste refusé car réellement mélangé) + rejet des lectures `i48` d'un slot hors de toute vie de ce slot (rangs fantômes 32/34) ; pas de bump de schéma si la forme du document ne change pas ; recuisson des 7 artefacts par le superviseur | Sonnet, worktree `LevelUp-wt-palette-unanimite` (`wt/palette-unanimite`) | tests abilities + golden, lint 0 ; après recuisson : 7 artefacts avec table de capacités, couverture des prises 96,5 → 99,1 % | [ ] |
