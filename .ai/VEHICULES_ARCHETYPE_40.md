...
(`RECETTE_LOADOUT_2026-07-27.md` §9 : `FUN_1407E7648` parcourt le bloc `sofd`, compare
...
`.ai/RECETTE_DECODAGE_FILM_CHUNKS.md` §47 annonce **174 archétypes valides**. L'outil
