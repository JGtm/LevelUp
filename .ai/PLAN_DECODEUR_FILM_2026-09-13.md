...
| `repli_i0_porte_et_region_par_defaut` | `games/halo_infinite/film/filmdec/i0_layout.go` | **carte_absente_du_catalogue / apres_lecture** (rétrogradé au lot 1.9.2 le 2026-09-15 : les deux chemins de `killcollector` imposent le catalogue, la lecture du référentiel précède partout) | n/i | — (non câblé) | **lot 1.9.4** (dernier appel de production de `DetectI0Layout` : l'identité de carte par signature) puis lot 3.x (profil par carte) |
