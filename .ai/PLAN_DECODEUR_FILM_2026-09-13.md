...
| 2026-09-14 | R1-6 (plafond) | ce commit | `golden_inputs_budget_test.go` : plafond **12 Mio** pour les huit `inputs_*.bin.gz`, valeur écrite avec sa date, son historique (10,35 → 17,79 → 9,86 → 10,32 → 10,53 Mio) et la règle « on ne relève pas sans décision écrite » | `TestGoldenInputsTiennentDansLeBudget` PASS : **11 044 440 o = 10,53 Mio**, ~14 % de marge. Le jeu de contrat pèse 2 564 084 o (plafond 3 145 728) |
