...
> Handoff pour reprise À FROID. État stratégique = `.ai/KILLFEED_STATE.md` (source de vérité, à lire en 1er).
> RE mécanisme = `.ai/KILLFEED_RE_FINDINGS.md`. Décodeur = `.ai/HANDOFF_FRAME_DECODER_L3.md`. Interdits = mémoire
