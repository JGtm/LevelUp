...
> Complément de `.ai/HANDOFF_MAP_GEOMETRY_FROM_MODULES.md` (master géométrie). PAS DE CODE écrit ici,
...
- Master géométrie : `.ai/HANDOFF_MAP_GEOMETRY_FROM_MODULES.md` (pipeline module→carte 2D, §9/§10).
