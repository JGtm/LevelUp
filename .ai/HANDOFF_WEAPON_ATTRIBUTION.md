...
Plan : **`.ai/PLAN_SAMECLOCK_ATTRIBUTION.md`** (lire en entier). Idée : corréler dégât↔MORT dans la MÊME horloge
...
Plan : **`.ai/PLAN_WEAPON_PER_KILL_PRODUCTION.md`**. Point d'insertion TRACÉ :
