...
class TestModeCategoriesCustom:
    ...
    def test_infer_mode_super_category_from_ui_labels(self) -> None:
        ...
        assert (
            infer_mode_super_category("Baptême du feu : Roi de la colline héroïque") == "Firefight"
        )
    ...
    def test_infer_custom_category_from_pair_name(self) -> None:
        ...
        assert (
            infer_custom_category_from_pair_name("Firefight:Heroic King of the Hill on SomeMap")
            == "Firefight"
        )
        assert (
            infer_custom_category_from_pair_name("Gruntpocalypse:Heroic KOTH on SomeMap")
            == "Firefight"
        )
