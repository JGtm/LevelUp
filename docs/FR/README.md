...
- **v7.0 — Page Synthèse** — une nouvelle entrée de navigation après Escouade regroupe les graphes de vue d'ensemble déjà présents dans l'app : résultats par carte/mode, heatmap de taux de victoire par jour et heure, top matchs vs volume hebdomadaire, avec en plus un comparatif Solo vs Escouade sur les métriques principales.
