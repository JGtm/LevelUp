...
| `objectives.Rev` | `facts/objectives` and the packages it imports (`internal/domain`, `film/types`...), plus the **value** of `source.Rev` | the objectives / statborg output can change — no backlog, the facts and the objective layers go stale |
