...
The full medal catalogue is populated from the 343i API; `SeedMedalDefinitions` (`internal/ops/seed.go`) injects the custom medals (e.g. `9000000001`) when `medal_definitions` is empty.
