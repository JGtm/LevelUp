...
go-api-test:
	cd $(GO_API_DIR) && CGO_ENABLED=0 LEVELUP_DEMO_MODE=true \
		go test ./internal/domain/... ./internal/analysis/... \
			./internal/games/halo_infinite/film/grammar/... ./internal/games/halo_infinite/film/facts/... ./internal/games/halo_infinite/film/replay/... \
			./contracttest/... \
...
go-api-lint:
	...
	if command -v golangci-lint >/dev/null 2>&1; then \
		...
		go vet ./internal/domain/... ./internal/analysis/... ./internal/games/halo_infinite/film/grammar/... ./internal/games/halo_infinite/film/facts/... ./internal/games/halo_infinite/film/replay/...; \
	fi
