...
// Le fixture est écrit dans `internal/games/halo_infinite/film/grammar/testdata/v41_chunk_he.bin`.
//
...
const (
	defaultFixturePath  = "internal/games/halo_infinite/film/grammar/testdata/v41_chunk_he.bin"
	manifestFixturePath = "internal/games/halo_infinite/film/grammar/testdata/v41_film_manifest.json"
)
