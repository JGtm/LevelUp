...
func main() {
	...
	envFile := flag.String("env-file", ".env.local", "chemin .env.local (SPNKR_AZURE_CLIENT_SECRET / LEVELUP_OAUTH_CLIENT_ID, refresh OAuth via SISUProvider + MultiUserTokenStore ADR 0023)")
...
// écraser celles déjà définies). Requis pour SPNKR_AZURE_CLIENT_SECRET /
