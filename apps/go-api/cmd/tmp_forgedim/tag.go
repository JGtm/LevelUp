...
// Parsing CachedTag (magic ucsh, v27) : header auto-verrouillé par l'invariant
// headerSize + dataSize == len(tag), tables dependencies / data-blocks / structs /
// data-refs / tag-refs / strings.
...
// refs renvoie les tag-refs NON VIDES. Layout du champ pointé (32o) :
