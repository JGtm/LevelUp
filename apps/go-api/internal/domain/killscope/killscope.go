...
//
// Leur propriétaire typé est `games/halo_infinite/film/internal/facts/killsource` (`Path`) — un paquet
...
//
// Propriétaire typé : `games/halo_infinite/film/internal/facts/killsource` (`Category`, énumération gelée par
