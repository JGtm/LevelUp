...
var preuvesLevelID = []struct {
	...
	// d objectifs. Meme methode, meme fichier-lien.
	...
	{"Fortitude Heavies", "fo05_desert"},
	{"Thunderhead Heavies", "fo08_wetland"},
	{"Thunderhead", "fo08_wetland"},
	{"Pharaoh", "fo11_blank"},
	{"Obituary Heavies", "fo09_academy"},
	...
	{"Disciple", "fo11_blank"},
	{"Ronin", "fo08_wetland"},
	{"Origin - Ranked", "fo08_wetland"},
	{"Nadair", "fo11_blank"},
	{"Outlook", "fo13_frost"},
	{"Refuge Heavies", "fo08_wetland"},
	{"Lattice - Ranked", "fo13_frost"},
	{"Rat's Nest", "fo08_wetland"},
	{"Insolence Heavies", "fo09_academy"},
