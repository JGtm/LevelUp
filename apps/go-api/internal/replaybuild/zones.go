...
func isHillVariant(variant string) bool {
	return objectives.ObjectiveTypeOf(variant) == objectives.ObjectiveTypeHill
}
...
func isSkullVariant(variant string) bool {
	return objectives.ObjectiveTypeOf(variant) == objectives.ObjectiveTypeSkull
}
...
func isBombVariant(variant string) bool {
	return objectives.ObjectiveTypeOf(variant) == objectives.ObjectiveTypeBomb
}
