...
//
//	armable  l'ARMEMENT (schema 29) — l'horloge du manifeste (start_ms par chunk, le
...
//	carry    le PORTAGE (schema 30) — aucune donnee de plus (le canal des armes tenues est
