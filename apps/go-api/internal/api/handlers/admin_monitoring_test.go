...
func TestAdminMonitoring_Detections_ListWithFilters(t *testing.T) {
	...
	h := NewAdminMonitoringHandler(nil, nil, nil, nil, runner, nil, nil, nil, nil, nil)
...
func TestAdminMonitoring_Detections_Patch(t *testing.T) {
	...
	h := NewAdminMonitoringHandler(nil, nil, nil, nil, nil, setter, nil, nil, nil, nil)
...
func TestAdminMonitoring_Freshness_OK(t *testing.T) {
	...
	h := NewAdminMonitoringHandler(nil, nil, nil, nil, nil, nil, runner, nil, nil, nil)
