...
func (h *PrestigeHandler) Mount(r chi.Router, opts ...humacore.MountOption) {
	...
	huma.Post(api, "/squads/{squad_id}/members", h.AddSquadMember, humacore.Op("addSquadMember", "Ajoute un membre à une escouade", "prestige"))
	huma.Delete(api, "/squads/{squad_id}/members/{xuid}", h.RemoveSquadMember, humacore.Op("removeSquadMember", "Retire un membre d'une escouade", "prestige"))
	huma.Post(api, "/squad-challenges/{id}/evaluate", h.EvaluateSquadChallenge, humacore.Op("evaluateSquadChallenge", "Évalue un défi d'escouade", "prestige"))
	huma.Get(api, "/squads/{squad_id}/orientation", h.SquadOrientation, humacore.Op("getSquadOrientation", "Orientation stratégique d'une escouade", "prestige"))

	huma.Post(api, "/pilot-mode/enable", h.EnablePilotMode, humacore.Op("enablePilotMode", "Active le mode pilote automatique Prestige", "prestige"))
	huma.Post(api, "/pilot-mode/disable", h.DisablePilotMode, humacore.Op("disablePilotMode", "Désactive le mode pilote automatique Prestige", "prestige"))
}
