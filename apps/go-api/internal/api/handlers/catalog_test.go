...
func TestCatalogHandler_Playlists(t *testing.T) {
	...
	r := chi.NewRouter()
	r.Get("/api/v1/titles/{slug}/catalog/playlists", h.PlaylistsHandler)
...
func TestCatalogHandler_Pairs(t *testing.T) {
	...
	r := chi.NewRouter()
	r.Get("/api/v1/titles/{slug}/catalog/pairs", h.PairsHandler)
...
func TestCatalogHandler_Maps(t *testing.T) {
	...
	r := chi.NewRouter()
	r.Get("/api/v1/titles/{slug}/catalog/maps", h.MapsHandler)
