	...
	Register(Migration{
		...
		ApplySchema: func(db *sql.DB) error {
			cols := []struct{ name, typ string }{
				...
				{"deaths", colSmallInt},
				{"assists", colSmallInt},
				{"shots_fired", colInteger},
				{"shots_hit", colInteger},
				{"damage_dealt", colFloat},
				{"damage_taken", colFloat},
				{"avg_life_seconds", colFloat},
				{"headshot_kills", colSmallInt},
				{"max_killing_spree", colSmallInt},
				{"kda", colFloat},
				{"accuracy", colFloat},
				{"time_played_seconds", colInteger},
				{"grenade_kills", colSmallInt},
				{"melee_kills", colSmallInt},
				{"power_weapon_kills", colSmallInt},
				{"personal_score", colInteger},
				{"team_mmr", colFloat},
				{"enemy_mmr", colFloat},
				{"kills_expected", colFloat},
				{"kills_stddev", colFloat},
				{"deaths_expected", colFloat},
				{"deaths_stddev", colFloat},
				{"backfill_bits", "INTEGER DEFAULT 0"},
			}
			for _, c := range cols {
