...
// service_arcs_squads.go — méthodes Service pour les arcs libres (création,
// liste, suppression, presets). Les défis d'escouade sont dans
// service_squad_challenges.go (extraits pour le seuil 500 L, CLAUDE.md règle 5).
//
