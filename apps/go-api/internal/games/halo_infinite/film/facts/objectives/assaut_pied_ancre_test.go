...
//	go test ./internal/games/halo_infinite/film/facts/objectives/ -run AssautPiedAncre -v -timeout 30m
...
//
//	go test ./internal/games/halo_infinite/film/facts/objectives/ -run AssautPiedFamilles -v -timeout 30m
...
//
//	go test ./internal/games/halo_infinite/film/facts/objectives/ -run AssautPiedExplosion -v -timeout 30m
...
//
//	go test ./internal/games/halo_infinite/film/facts/objectives/ -run AssautPiedPose -v -timeout 30m
