...
//	go test ./internal/games/halo_infinite/film/facts/objectives/ -run AssautPiedClassement -v -timeout 30m
...
//
//	go test ./internal/games/halo_infinite/film/facts/objectives/ -run AssautPiedEtendu -v -timeout 30m
...
//
//	go test ./internal/games/halo_infinite/film/facts/objectives/ -run AssautPiedRares -v -timeout 30m
...
//
//	go test ./internal/games/halo_infinite/film/facts/objectives/ -run AssautPiedTemoinsTags -v -timeout 30m
