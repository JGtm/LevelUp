...
// la plus longue de toutes, et la laisser dans le litteral poussait `tableProfilInvariants`
// au-dela du plafond de lignes que le ratchet fige. Le lecteur du catalogue commis evalue les
// constantes du fichier : la conformite est prouvee comme avec un litteral.
