...
// rev_chronique_archive_5.go - LA CHRONIQUE DE [Rev], RANGS `grammar-2026-09-21.5` A
// `grammar-2026-09-22.6`.
//
// # POURQUOI CETTE CINQUIEME ARCHIVE (2026-09-22, lot 5.20.1)
//
// La chronique ne peut que grandir : un lot, un rang, une entree. `rev_chronique.go` avait
// atteint 496 lignes et l entree du lot 5.20.1 l aurait fait passer le seuil de 500 du ratchet
// de taille (`archlint/film_file_size_test.go`). Les rangs `grammar-2026-09-21.5` a
// `grammar-2026-09-22.6` sont donc verses ici, mot pour mot, et la suite VIVANTE repart au
// `grammar-2026-09-22.7`. C est le geste ordinaire annonce par l en-tete des quatre archives
// precedentes, pas un incident.
//
// ATTENTION, ET C EST UNE DIFFERENCE AVEC LES DEUX PREMIERES ARCHIVES : seuls `rev.go`,
// `rev_chronique.go`, `rev_chronique_archive.go` et `rev_chronique_archive_2.go` figurent dans
// `fichiersHorsGrammaire` (`rev_test.go`). Les archives `_3`, `_4` et celle-ci sont donc HACHEES
// par l empreinte : y ecrire une ligne fait monter l empreinte de la couche. Le constat est
// consigne au paragraphe 4 du lot 5.20 ; il n est pas corrige ici (hors perimetre).
