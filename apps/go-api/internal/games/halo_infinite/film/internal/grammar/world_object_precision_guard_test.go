...
var worldObjectPrecisionReaders = map[string]string{
	...
	"internal/games/halo_infinite/film/internal/grammar/film_context.go": "les trois accès du CONTEXTE " +
	...
	"internal/games/halo_infinite/film/internal/profile/profile_table.go": "la LIGNE DE TABLE de " +
