...
// rev_chronique_archive_2.go — LA CHRONIQUE DE [Rev], RANGS `.29` A `.42` PUIS LE PREMIER
// RANG DU 18 (`grammar-2026-09-18`).
//
...
//
// SECONDE ROTATION DU 2026-09-21 (lot 5.11.0-a) : meme cause, meme geste. `rev_chronique.go` a
// repasse les 500 lignes en recevant l entree du compte du second tour d `i63` ; l entree
// `grammar-2026-09-18` (la premiere du 18, lot 5.1.1) est versee ici, a la suite du `.42`, ce qui
// garde l ordre chronologique que le gate exige. DEPLACEMENT PUR : pas un mot de l entree ne
// change.
//
