...
// rev_chronique_archive.go — LES RANGS ANCIENS DE LA CHRONIQUE DES FAITS.
//
// ROTATION DU 2026-09-21 (lot 5.10.1), geste ORDINAIRE et deja fait deux fois cote `grammar` :
// `rev_chronique.go` atteignait 510 lignes et le ratchet de taille
// (`archlint/film_file_size_test.go`) refuse de le laisser grandir. Les rangs
...
//
// La suite VIVANTE de la chronique, a partir de `killsource-2026-09-16.7`, est dans
// `rev_chronique.go`.
