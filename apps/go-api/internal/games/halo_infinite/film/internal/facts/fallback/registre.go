...
// le paquet des sites. Un nouveau fichier s'ajoute à [Tranches], et à rien d'autre (le huitième,
// `registre_replay_positions.go`, au lot M1 des retours du rejeu, 2026-09-23).
