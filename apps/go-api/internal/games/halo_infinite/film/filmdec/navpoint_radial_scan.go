...
// cette variante — la garde est chez l'appelant (`games/halo_infinite/film/replay`).
//
...
// est le travail de l'interpretation (`games/halo_infinite/film/replay`), pas du decodeur.
//
