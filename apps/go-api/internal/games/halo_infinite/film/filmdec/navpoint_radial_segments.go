...
// (`games/halo_infinite/film/replay/bomb_armings.go`) : ce paquet ne connait ni les explosions ni le mode.
//
...
// finit aussi a son sommet ; c'est l'interpretation qui exige le plein (`games/halo_infinite/film/replay`).
