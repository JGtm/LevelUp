...
//	  go test ./internal/games/halo_infinite/film/filmdec/ -run '^TestWorldObjectPrecisionImpact$' -timeout 60m -v
//
//	CGO_ENABLED=0 WORLDPREC_FILM=... \
//	  go test ./internal/games/halo_infinite/film/filmdec/ -run '^TestWorldObjectPrecisionLayout$' -timeout 10m -v
