...
//
// TOUT CE FICHIER EST PUR : il travaille sur un payload d image-cle deja en memoire. Son entree
// de balayage (`ScanFilmKeyframeRecordSpans`) est arrivee du chantier vehicules SANS AUCUN
