...
//	go test -count=1 -run TestTi13EtatLotCbis -v ./internal/games/halo_infinite/film/filmdec/
...
// dure : `internal/games/halo_infinite/film/replay` importe `filmdec`, donc `filmdec` ne peut pas importer
