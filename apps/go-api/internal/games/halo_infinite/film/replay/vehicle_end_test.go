...
func vieDeTest(slot, gen uint32, firstUS, lastUS, goneByUS, loUS, hiUS uint64) vehicleLife {
	return vehicleLife{
		key: filmdec.EquipmentLifeKey{Slot: slot, Gen: gen}, firstUS: firstUS, lastUS: lastUS,
...
func TestAssignVehicleDeathsSansVie(t *testing.T) {
	tally := assignVehicleDeaths(nil, []filmdec.ObjectDeath{{TimestampUS: 1, Slot: 5}})
...
func TestAssignVehicleWindowsSansBorneHaute(t *testing.T) {
	lives := []vehicleLife{
		{key: filmdec.EquipmentLifeKey{Slot: 777, Gen: 1}, firstUS: 0, lastUS: 200_000_000, goneByUS: 0},
	}
...
func TestAssignVehicleWindowsFrontiereEntreDeuxVies(t *testing.T) {
	lives := []vehicleLife{
		{key: filmdec.EquipmentLifeKey{Slot: 777, Gen: 1}, firstUS: 0, lastUS: 40_000_000, goneByUS: 0},
		{key: filmdec.EquipmentLifeKey{Slot: 777, Gen: 2}, firstUS: 100_000_000, lastUS: 140_000_000},
	}
	assignVehicleWindows(lives)
...
func TestVehicleLivesPoseLaMortEcrite(t *testing.T) {
	...
	deaths := []filmdec.ObjectDeath{{TimestampUS: 45_000_000, Slot: 777, Gen: 1}}
...
func TestFinDeVieIgnorerLeDeadStateRendUneFinFausse(t *testing.T) {
	...
	deaths := []filmdec.ObjectDeath{{TimestampUS: mortUS, Slot: 777, Gen: 1}}
