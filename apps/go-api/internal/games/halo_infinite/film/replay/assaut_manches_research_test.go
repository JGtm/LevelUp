...
//	go test ./internal/games/halo_infinite/film/replay/ -run AssautManchesControle -v -timeout 60m
...
//
//	$env:ASSAUT_CACHE="C:/.../data/cache" ; go test ./internal/games/halo_infinite/film/replay/ -run AssautPointsDeMode -v
