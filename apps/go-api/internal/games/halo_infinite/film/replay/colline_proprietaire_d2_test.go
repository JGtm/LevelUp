...
// DEJA EN PRODUCTION depuis le schema 12 (`objectives.SeriesTotal` + `ModeScoreComponent`),
...
//
//	$env:ZONE_FILM="<cache>/film_chunks/01e1f945"; go test ./internal/games/halo_infinite/film/replay/ -run CollineProprietaireD2 -v
