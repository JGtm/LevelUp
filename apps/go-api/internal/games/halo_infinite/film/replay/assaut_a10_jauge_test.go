...
//	go test ./internal/games/halo_infinite/film/replay/ -run AssautA10 -v -timeout 60m
...
//
//	go test ./internal/games/halo_infinite/film/replay/ -run AssautA10Detail -v -timeout 30m
