...
// ranked_playlists_test.go — tests applyRankedPlaylistSeeds déplacés depuis
// internal/migration (Phase 1.5 b12). Self-contained : créent le schéma
// playlists_catalog + asset_translations à la main et appellent applyRankedPlaylistSeeds.
package migrations
...
// TestApplyRankedPlaylistSeeds_FixesStuckFalse : une playlist classée pré-existante
// marquée is_ranked=FALSE / experience='social' est corrigée (DO UPDATE).
...
// TestApplyRankedPlaylistSeeds_SeedsActiveAndFR : les playlists classées actives sont
// présentes après seed, et leur traduction FR existe.
...
// TestApplyRankedPlaylistSeeds_Idempotent : un second passage ne casse rien.
