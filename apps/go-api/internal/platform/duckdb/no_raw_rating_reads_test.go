...
func TestNoRawAppendOnlyReads(t *testing.T) {
	...
	// 2026-09-13 (lot finitions LUSR, C.3) : `queries_career.go` RETIRÉ de l'allowlist.
	// Q8LUSRHistoryPlayer lit désormais match_skill_rank_latest — le motif « le graphe
	// veut TOUS les checkpoints » rendait le graphe d'évolution non réparable par un
	// replay append-only (résidu h5_arena du 2026-06-26 encore tracé après la
