...
func (r *MatchViewRepo) GetMatchScoreboard(ctx context.Context, matchID string) ([]domain.ScoreboardRaw, error) {
	...
	for rows.Next() {
		...
		if err := rows.Scan(
			...
			&s.DeathsStdDev,
			&s.Obj.FlagCaptures,
			&s.Obj.FlagCaptureAssists,
			&s.Obj.FlagGrabs,
			&s.Obj.FlagSecures,
			&s.Obj.FlagSteals,
			&s.Obj.FlagReturns,
			&s.Obj.FlagCarriersKilled,
			&s.Obj.FlagReturnersKilled,
			&s.Obj.KillsAsFlagCarrier,
			&s.Obj.KillsAsFlagReturner,
			&s.Obj.TimeAsFlagCarrierSeconds,
			&s.Obj.ZoneCaptures,
			&s.Obj.ZoneSecures,
			&s.Obj.ZoneOffensiveKills,
			&s.Obj.ZoneDefensiveKills,
			&s.Obj.ZoneScoringTicks,
			&s.Obj.TimeInZonesSeconds,
			&s.Obj.KillsAsSkullCarrier,
			&s.Obj.SkullCarriersKilled,
			&s.Obj.SkullGrabs,
			&s.Obj.SkullScoringTicks,
			&s.Obj.TimeAsSkullCarrierSeconds,
			&s.Obj.LongestTimeAsSkullCarrierSeconds,
			&s.Obj.KillsAsPowerSeedCarrier,
			&s.Obj.PowerSeedCarriersKilled,
			&s.Obj.PowerSeedsDeposited,
			&s.Obj.PowerSeedsStolen,
			&s.Obj.TimeAsPowerSeedCarrierSeconds,
			&s.Obj.TimeAsPowerSeedDriverSeconds,
			&s.Obj.ExtractionConversionsCompleted,
			&s.Obj.ExtractionConversionsDenied,
			&s.Obj.ExtractionInitiationsCompleted,
			&s.Obj.ExtractionInitiationsDenied,
			&s.Obj.SuccessfulExtractions,
			&s.Obj.KillsAsVip,
			&s.Obj.VipKills,
			&s.Obj.VipAssists,
			&s.Obj.TimesSelectedAsVip,
			&s.Obj.MaxKillingSpreeAsVip,
			&s.Obj.TimeAsVipSeconds,
			&s.Obj.LongestTimeAsVipSeconds,
		); err != nil {
