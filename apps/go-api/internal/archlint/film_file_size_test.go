...
var plafondsParFichier = map[string]int{
	...
	// SCHEMA 69 -> 70 (2026-09-24, integration de la vague D des retours du rejeu) : 2142 -> 2276,
	...
	// Partie M3 (2026-09-23) et en-tete commun complete a sa fusion (`facts.Rev`), +59 : la
	// dotation de naissance, `loadouts[].src` et `.k`, `weaponChanges[].k`, le changement de SENS
	// des premieres emissions, `coverage.keyframes` et `.birthLoadouts`.
	// Exception ecrite, dans les commits de fusion qui reunissent la montee.
	"internal/games/halo_infinite/film/replay/document_chronicle.go": 2276,
	...
	// SCHEMA 69 -> 70 (2026-09-24, integration de la vague D des retours du rejeu) : 1293 -> 1325,
	// la justification UNIQUE que `TestStructureIsOptionalInDocument` exige pour la montee commune
	...
	// montee.
	"internal/games/halo_infinite/film/replay/structure_test.go":                                  1325,
