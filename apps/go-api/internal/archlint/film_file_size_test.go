...
var plafondsParFichier = map[string]int{
	...
	// SCHEMA 68 -> 69 (2026-09-23, lot M2.3 de la campagne « retours rejeu ») : 2018 -> 2072,
	// l entree de chronique v69 — la regle des places de l utilisateur, `roster[].presence` qui
