...
var plafondsParFichier = map[string]int{
	...
	// SCHEMA 69 -> 70 (2026-09-24, lot M6 des retours du rejeu) : 2142 -> 2160, l entree v70 — la
	// remise des mains nues sort des ramassages (`pickups[]`, `coverage.pickups.unarmedGrants`) et
	// les trois familles nommees au catalogue du titre. Exception ecrite, meme commit que
	// `SchemaVersion`.
	"internal/games/halo_infinite/film/replay/document_chronicle.go": 2160,
	...
	// SCHEMA 69 -> 70 (2026-09-24, lot M6 des retours du rejeu) : 1293 -> 1298, la justification
	// de la montee (remise des mains nues hors des ramassages, compteur `unarmedGrants`). Exception
	// ecrite, meme commit que `SchemaVersion`.
	"internal/games/halo_infinite/film/replay/structure_test.go":                                  1298,
