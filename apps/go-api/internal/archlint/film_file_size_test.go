...
var plafondsParFichier = map[string]int{
	...
	// `SchemaVersion`.
	// SCHEMA 68 -> 69 (2026-09-23, retours du rejeu, lot M4a) : 1270 -> 1279, la justification
	// que `TestStructureIsOptionalInDocument` exige — les pieces montees posees sur leur
	// porteur, le sens neuf de `v` d un tir d artilleur et du `seat` reporte, et ce qui ne monte
	// pas. Exception ecrite, meme commit que `SchemaVersion`.
