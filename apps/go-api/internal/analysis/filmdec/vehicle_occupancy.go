...
//
// CE QUE CE FICHIER LIVRE, EN CONSÉQUENCE : une MESURE, pas un verdict. `VehicleKeyframeStates`
...
//
// TOUT CE FICHIER EST PUR. Son entrée de balayage (`ScanFilmVehicleOccupancy`, qui chaînait
// `ScanKeyframeRecordSpans` puis `VehicleKeyframeStates`) est arrivée du chantier véhicules SANS
// AUCUN APPELANT, tests compris, et a été retirée à l'intégration du 2026-09-05 (règle 0 du
...
// PUR (aucune I/O), comme tout ce fichier.
//
