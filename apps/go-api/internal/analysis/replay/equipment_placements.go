...
type EquipmentPlacement struct {
	...
	// Until / UntilMax / End (schéma 27) : la FIN D'AFFICHAGE OBSERVÉE — ce que T1 n'a jamais
	...
	//
	// End vide = artefact antérieur au schéma 27 : aucune fin observée, même règle de lecture
	// qu'Origin absent.
...
type EquipmentPlacementCoverage struct {
	...
	// EndSeen / EndOpen (schema 27) : les fins d affichage observees — disparition bornee par
...
// proximité mesurée, cap par la visée du poseur — et, depuis le schéma 27, la FIN OBSERVÉE
