...
// ground_weapon_rules.go — LES RÈGLES de la chaîne des ARMES AU SOL : les seuils du plan, ce
// qu'est une apparition, comment elle se classe, comment les apparitions font un SOCLE, et quand
// un CYCLE est établi. Le BORNAGE et la DATATION d'une disparition vivent à côté
// (`ground_weapon_bounds.go`) — même lot, même règle, seuil de 500 lignes du dépôt.
//
