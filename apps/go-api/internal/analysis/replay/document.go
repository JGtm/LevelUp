...
//
// LE NUMÉRO 42 EST RÉSERVÉ au complément des ports de drapeau, en cours sur une autre branche.
// La version monte pour la raison des montées v39/v40/v41 : un artefact 23 à 42 est appauvri
