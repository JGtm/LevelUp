...
func TestWeaponChangesSurFilmReel(t *testing.T) {
	...
	t.Logf("FRAMES : derniere frame du document=%d ; plus grand instant publie=%d "+
		"(l'affichage au sol vit dans groundWeapons depuis le schema 27)", doc.FrameCount, maxT)
...
// TestGroundWeaponsSurFilmReel — le calque des armes au sol observees (schema 27), de bout en
