...
//
// CE QUE C'EST, ET CE QUE ÇA REMPLACE. Le schéma 24 publiait le lâcher avec une borne
...
//
//   - `pickup`  une prise du flux delta (schéma 24, datée à la milliseconde) tombe dans la
...
//     REGISTRE_REPORTS (« un oracle plus rapproché que 20 s ») — levée par le schéma 24.
...
// schéma 24 ; `positions` est le nuage NON décimé trié par instant — la position d'un acteur à
