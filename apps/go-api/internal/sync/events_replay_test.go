...
// `internal/games/halo_infinite/film/grammar/testdata/v41_chunk_he.bin`, servi par le mock client.
package sync
...
// internal/games/halo_infinite/film/grammar/testdata/v41_chunk_he.bin. Le path est relatif au dossier
