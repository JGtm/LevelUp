...
//
// LE CHOIX DU FICHIER N'EST PAS FAIT ICI : il vit dans `mapcatalog.ChoisirFichierVariante`,
// que la CLI de generation consomme aussi. Deux implementations de cette regle divergeraient,
// et la divergence est ce qui a coute des socles deplaces de 80 metres.
func (c *HaloAPIClient) FetchMvarForMap(ctx context.Context, mapID, mvarFile string,
	...
	choisi := mapcatalog.ChoisirFichierVariante(chemins, mvarFile)
