...
// Labels FR = FormatTierLabel() côté Go ; labels EN = valeur brute API.
const LUSR_TIERS = [
  { min: 1200, max: 1400, token: 'perf-tier-1' as const, fr: 'Argent',  en: 'Silver'   },
  { min: 1400, max: 1600, token: 'perf-tier-2' as const, fr: 'Or',      en: 'Gold'     },
  { min: 1600, max: 1800, token: 'perf-tier-3' as const, fr: 'Platine', en: 'Platinum' },
  { min: 1800, max: 2000, token: 'perf-tier-4' as const, fr: 'Diamant', en: 'Diamond'  },
  { min: 2000, max: 9999, token: 'perf-tier-5' as const, fr: 'Onyx',    en: 'Onyx'     },
]
