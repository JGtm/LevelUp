    ...
    sections: [
      {
        ...
        entries: [
          ...
          },
          {
            ...
            example:
              "Sur vos 200 derniers matchs PvP rankés, votre pace moyen est 1.18× le pace per-player de vos équipes (coef_team_share = 1.18). Vous prenez donc 29.5% du travail dans un 4v4 (au lieu de la fair share 25%). Sur la même période, vous faites 1.05× le pace per-player du lobby (coef_lobby_share = 1.05) → vous êtes légèrement plus actif que la moyenne du lobby, mais surtout fort dans votre équipe vs vos coéquipiers.",
          },
          {
