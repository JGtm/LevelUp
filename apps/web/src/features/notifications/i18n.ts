...
const FR: NotificationsText = {
  ...
  categoryDescription: {
    ...
    season_pass_level: 'Catégorie historique remplacée par « Rang de carrière » et « Battle pass terminé ».',
    ...
    career_rank: 'Tu as gagné un nouveau rang de carrière Halo (lifetime).',
    skill_tier: 'Tu as changé de tier compétitif sur une playlist (CSR ou LUSR).',
  ...
  templates: {
    ...
    'notif.skill_tier.title': 'Nouveau tier {tier} ({rating_type})',
    'notif.skill_tier.body': 'Playlist {playlist_group} — tier {tier} sous-palier {sub_tier} (avant : {previous_tier} {previous_sub_tier}).',
    'notif.battlepass_completed.title': 'Battle pass terminé',
    'notif.battlepass_completed.body': '{count} track(s) BP atteint(s) au rang max — félicitations !',
    'notif.citation_tier.title': 'Nouveau palier de commendation',
...
const EN: NotificationsText = {
  ...
  templates: {
    ...
    'notif.skill_tier.body': 'Playlist {playlist_group} — tier {tier} sub {sub_tier} (was: {previous_tier} {previous_sub_tier}).',
