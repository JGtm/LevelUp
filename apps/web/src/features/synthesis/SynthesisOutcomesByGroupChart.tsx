...
function buildOutcomesOption(entries: GroupEntry[], labels: OutcomeLabels): EChartsCoreOption {
...
export function SynthesisOutcomesByGroupChart({ entries, title, height }: Props) {
  ...
  const buildOption = useCallback(
    () => buildOutcomesOption(entries, { win: winLabel, loss: lossLabel, tie: tieLabel, dnf: dnfLabel }),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [JSON.stringify(entries), winLabel, lossLabel, tieLabel, dnfLabel],
  )
