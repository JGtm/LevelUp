...
/**
 * LES ARMES AU SOL SONT ALLUMÉES PAR DÉFAUT (schéma 26). Même raisonnement que les objets de
...
export interface ReplaySettings {
  ...
  /**
   * Calque des ARMES AU SOL (schéma 26) — les armes abandonnées, distinctes des socles.
