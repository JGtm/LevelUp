 ...
 * film, le DOCUMENT ne lui porte qu'UNE position, à la naissance (`samples[0].t === t0`), la vie
 * court jusqu'à la fin du film et personne n'y monte jamais. (Le FILM, lui, réplique la pose avant
 * l'origine du document et écrit que l'objet est posé par la carte — index de placement Forge,
 * sonde C2 du 2026-09-24 ; la règle, générale, reste identique sur le parc.)
 *
