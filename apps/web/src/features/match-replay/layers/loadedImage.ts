 ...
 * chargée, à son chargement sinon. Une image qui échoue n'appelle rien (le calque garde son tracé
 * de repli), comme avant.
 */
export function withLoadedImage(url: string, ready: (image: HTMLImageElement) => void): void {
