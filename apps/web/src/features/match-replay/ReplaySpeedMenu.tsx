 ...
 * aucun réglage n'est réinventé ici. La note « son coupé » ne redéfinit pas non plus la borne :
 * elle INTERROGE `soundPlaysAtSpeed`, la fonction qui décide réellement du silence dans le
 * lecteur (replaySoundCursor.ts). Une constante locale de plus aurait été la troisième copie
 * de la même règle — et celle qui se serait tue le jour où la borne bouge.
 */
