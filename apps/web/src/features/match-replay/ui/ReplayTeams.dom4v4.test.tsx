 ...
 * voit.
 *
 * FIXTURES REGENEREES UNE FOIS, A LA FUSION DANS `feat/v75` (2026-09-07) — et une seule
 * addition, verifiee balise par balise : le glyphe « capacité non lue sur cette vie » de la
 * cellule de capacité (5 occurrences en 4v4, 9 en 6v6). Il vient du correctif P0-2 du lot des
 * vies anonymes (`feat/v2-integ`, 2026-09-06), pas de ce lot-ci : la fixation avait été prise
 * sur une base ANTERIEURE a ce correctif, quand une vie sans lecture de capacité ne rendait
 * rien du tout. Aucun autre nœud, attribut, classe ni `title` ne bouge — la promesse « aucune
