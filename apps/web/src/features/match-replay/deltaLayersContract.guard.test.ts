...
/**
 * Garde-rail (CLAUDE.md n° 6) : LES TYPES ÉCRITS À LA MAIN DES SCHÉMAS 24-26 NE DOIVENT JAMAIS
...
describe('garde-rail : les types manuels des schémas 24-26 <-> les structures Go', () => {
