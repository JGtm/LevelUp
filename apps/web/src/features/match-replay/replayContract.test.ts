...
const NULLABLE_ARRAYS = [
  ...
  'skullCarries',
  // `weaponChanges` : LES PRISES ET LES LÂCHERS D'ARME (schéma 24, 2026-08-30) — le composant
  ...
  'weaponChanges',
  // `equipmentChanges` : LES RAMASSAGES ET LES CONSOMMATIONS d'équipement (schéma 25,
  ...
  'equipmentChanges',
  // `groundWeapons` : LES ARMES AU SOL individuelles (schéma 26, 2026-08-30) — un objet par
...
const NULLABLE_ARRAY_PATHS = [
  ...
  'skullCarries',
  // Schémas 24-26 : trois calques PLATS, aucun tableau imbriqué — un seul chemin chacun. Les
