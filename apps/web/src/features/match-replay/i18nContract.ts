 ...
 *     (`padPickups[].xuid` est publié depuis le schéma 29 mais cet écran ne l'exploite pas) :
...
export interface ReplayText {
   ...
   * n'est pas AFFICHÉ (`padPickups[].xuid` est publié depuis le schéma 29 ; cet écran ne
