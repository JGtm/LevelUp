/**
 * SessionNavBar — barre sticky de navigation entre sessions (page Stats).
 *
 * Visible uniquement quand une session est pickée (mode Session). En mode
 * Analyse (toutes sessions / période / filtres uniquement), la barre est
 * masquée — l'info était redondante avec le briefing en haut de page (KPI grid
 * affiche déjà le compteur de matchs) et le FilterOmnibar (filtres actifs).
 *
...
export function SessionNavBar() {
  ...
  // Mode Analyse (pas de session pickée) : barre masquée — l'info "Toutes les
  // sessions · N filtres · N matchs" était redondante avec le briefing en haut
  // de la page Stats (KPI grid affiche déjà le nombre de matchs sur le scope,
  // les filtres actifs sont visibles dans le FilterOmnibar). On garde la barre
  // uniquement en mode Session (navigation Précédente/Suivante/Dernière).
