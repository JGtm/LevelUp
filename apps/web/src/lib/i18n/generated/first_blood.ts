...
export const firstBloodManifest = {
  ...
  "first_blood.tooltip.first_death": { fr: "{player} · match {match} · première mort {time}", en: "{player} · match {match} · first death {time}" },
  "first_blood.tooltip.first_kill": { fr: "{player} · match {match} · premier frag {time}", en: "{player} · match {match} · first kill {time}" },
