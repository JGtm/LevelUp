...
export const explorerManifest = {
  ...
  "explorer.filters.date": { fr: "Date", en: "Date" },
  "explorer.filters.experience_placeholder": { fr: "PvP, PvE…", en: "PvP, PvE…" },
  "explorer.filters.experience_type": { fr: "Type d'expérience", en: "Experience type" },
  "explorer.filters.map": { fr: "Carte", en: "Map" },
  "explorer.filters.map_placeholder": { fr: "Filtrer carte…", en: "Filter map…" },
  "explorer.filters.mode": { fr: "Mode", en: "Mode" },
  "explorer.filters.mode_placeholder": { fr: "Filtrer mode…", en: "Filter mode…" },
  "explorer.filters.playlist": { fr: "Playlist", en: "Playlist" },
  "explorer.filters.playlist_placeholder": { fr: "Filtrer playlist…", en: "Filter playlist…" },
