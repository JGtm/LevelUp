...
export const explorerManifest = {
  ...
  "explorer.filters.ranked_label": { fr: "Expérience", en: "Experience" },
  "explorer.filters.ranked_ranked": { fr: "Classé (CSR)", en: "Ranked (CSR)" },
  "explorer.filters.ranked_unranked": { fr: "Non classé (LUSR)", en: "Unranked (LUSR)" },
