...
export const fragsManifest = {
  ...
  "frags.class.shoulder": { fr: "Arme d'épaule", en: "Shoulder" },
  "frags.class.sidearm": { fr: "Arme de poing", en: "Sidearm" },
  ...
  "frags.role.grenade_dynamo": { fr: "Dynamo", en: "Dynamo" },
  "frags.role.grenade_frag": { fr: "Fragmentation", en: "Fragmentation" },
  "frags.role.grenade_other": { fr: "Autre grenade", en: "Other grenade" },
  "frags.role.grenade_plasma": { fr: "Plasma", en: "Plasma" },
  "frags.role.grenade_splinter": { fr: "Splinter", en: "Splinter" },
  ...
  "frags.role.shoulder_bash": { fr: "Charge spartane", en: "Shoulder bash" },
