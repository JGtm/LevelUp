...
export const synthesisManifest = {
  ...
  "synthesis.relations.empty_title": { fr: "Aucune relation détectée", en: "No relationship detected" },
  "synthesis.relations.frequent_allies_title": { fr: "Alliés fréquents", en: "Frequent allies" },
  "synthesis.relations.matches_with": { fr: "matchs · avec", en: "matches · with" },
  "synthesis.relations.open_full_view": { fr: "Ouvrir la vue complète", en: "Open full view" },
  "synthesis.relations.section_description": { fr: "Les visages qui reviennent le plus souvent dans le scope courant.", en: "The faces appearing most frequently in the current scope." },
  "synthesis.relations.section_title": { fr: "Relations de jeu", en: "Gameplay relationships" },
