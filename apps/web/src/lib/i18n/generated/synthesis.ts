...
export const synthesisManifest = {
  ...
  "synthesis.combat_profile.hijacks": { fr: "Détournements", en: "Hijacks" },
  ...
  "synthesis.stats_detail.damage_dealt_fallback": { fr: "Dégâts infligés", en: "Damage dealt" },
  "synthesis.stats_detail.damage_taken_fallback": { fr: "Dégâts reçus", en: "Damage taken" },
  "synthesis.stats_detail.headshot_kills_fallback": { fr: "Tirs à la tête", en: "Headshot kills" },
  "synthesis.stats_detail.shots_fired_fallback": { fr: "Tirs effectués", en: "Shots fired" },
  ...
  "synthesis.weapon_range.elev_axis_x": { fr: "Distance de l'engagement", en: "Engagement distance" },
  "synthesis.weapon_range.elev_axis_y": { fr: "Hauteur (m)", en: "Height (m)" },
  "synthesis.weapon_range.elev_coverage": { fr: "{mk, number} frags mesurés sur {tk, number}, {md, number} morts sur {td, number}", en: "{mk, number} kills measured of {tk, number}, {md, number} deaths of {td, number}" },
  "synthesis.weapon_range.elev_level_band": { fr: "À niveau (± 1 m)", en: "Level (± 1 m)" },
  "synthesis.weapon_range.elev_median_deaths": { fr: "médiane morts {value}", en: "deaths median {value}" },
  "synthesis.weapon_range.elev_median_kills": { fr: "médiane frags {value}", en: "kills median {value}" },
  "synthesis.weapon_range.elev_medians": { fr: "Médianes", en: "Medians" },
  "synthesis.weapon_range.elev_point_death": { fr: "Une mort", en: "A death" },
  "synthesis.weapon_range.elev_point_kill": { fr: "Un frag", en: "A kill" },
  "synthesis.weapon_range.elev_quartiles": { fr: "Du 1er au 3e quartile", en: "1st to 3rd quartile" },
  "synthesis.weapon_range.elevation_empty": { fr: "Aucun engagement mesuré sur cette période : les positions des frags ne sont pas encore décodées pour ces matchs.", en: "No measured engagement over this period: kill positions are not decoded yet for these matches." },
  "synthesis.weapon_range.elevation_subtitle": { fr: "Hauteur d'engagement", en: "Engagement height" },
  "synthesis.weapon_range.elevation_subtitle_detail": { fr: "La hauteur d'engagement est votre hauteur moins celle de l'adversaire au moment du coup fatal. Le signe est toujours le vôtre : positif, vous étiez en surplomb, pour un frag comme pour une mort. Seuls les engagements dont les deux positions sont décodées y figurent, et le pied de carte en donne le compte.", en: "Engagement height is your height minus your opponent's at the moment of the killing blow. The sign is always yours: positive means you were on high ground, for a kill as for a death. Only engagements whose two positions are decoded appear here, and the card footer gives the count." },
  ...
  "synthesis.weapon_range.legend_elevation_label": { fr: "Légende de la hauteur d'engagement", en: "Engagement height legend" },
  ...
  "synthesis.weapon_range.range_subtitle_detail": { fr: "Le bâton court du 10e au 90e centile ; le losange marque la médiane. Frags au-dessus, morts en dessous — sur les morts, l'arme est celle du tueur.", en: "The bar runs from the 10th to the 90th percentile; the diamond marks the median. Kills on top, deaths below — on deaths, the weapon is the killer's." },
  "synthesis.weapon_range.side_deaths": { fr: "Mes morts", en: "My deaths" },
  "synthesis.weapon_range.side_kills": { fr: "Mes frags", en: "My kills" },
  "synthesis.weapon_range.table_above": { fr: "En surplomb", en: "On high ground" },
  "synthesis.weapon_range.table_below": { fr: "En contrebas", en: "On low ground" },
