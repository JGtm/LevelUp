...
export const synthesisManifest = {
  ...
  "synthesis.weapon_range.elev_axis_y": { fr: "Dénivelé (m)", en: "Elevation (m)" },
  ...
  "synthesis.weapon_range.elevation_subtitle_detail": { fr: "Le dénivelé est votre hauteur moins celle de l'adversaire au moment du coup fatal. Le signe est toujours le vôtre : positif, vous étiez au-dessus, pour un frag comme pour une mort. Seuls les engagements dont les deux positions sont décodées y figurent, et le pied de carte en donne le compte.", en: "Elevation is your height minus your opponent's at the moment of the killing blow. The sign is always yours: positive means you were above, for a kill as for a death. Only engagements whose two positions are decoded appear here, and the card footer gives the count." },
