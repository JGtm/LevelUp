...
export const feedbackDrawerManifest = {
  ...
  "feedback_drawer.rate_limit": { fr: "Merci, tu as déjà envoyé 5 retours dans la dernière heure.", en: "Thanks, you already sent 5 feedbacks in the last hour." },
  ...
  "feedback_drawer.submit_note": { fr: "Tu seras redirigé vers GitHub pour finaliser l'envoi. Une analyse automatique enrichira l'issue.", en: "You'll be redirected to GitHub to finalize the submission. An automated analysis will enrich the issue." },
