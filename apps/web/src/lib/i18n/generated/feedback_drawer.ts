...
export const feedbackDrawerManifest = {
  ...
  "feedback_drawer.field.description_placeholder": { fr: "Ce qui s'est passé, ce que vous attendiez, étapes pour reproduire…", en: "What happened, what you expected, steps to reproduce…" },
  "feedback_drawer.field.title": { fr: "Titre", en: "Title" },
  "feedback_drawer.field.title_placeholder": { fr: "Résumez votre retour en quelques mots", en: "Sum up your feedback in a few words" },
  ...
  "feedback_drawer.rate_limit": { fr: "Merci, vous avez déjà envoyé 5 retours dans la dernière heure.", en: "Thanks, you already sent 5 feedbacks in the last hour." },
  ...
  "feedback_drawer.submit_note": { fr: "Vous serez redirigé vers GitHub pour finaliser l'envoi. Une analyse automatique enrichira l'issue.", en: "You'll be redirected to GitHub to finalize the submission. An automated analysis will enrich the issue." },
