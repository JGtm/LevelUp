...
// ---------------------------------------------------------------------------
// Schémas 24 à 26 du document de rejeu — ÉCRITS À LA MAIN, et voici pourquoi.
//
// Le contrat `api/openapi.yaml` est GÉNÉRÉ depuis les DTO Go (`make openapi-gen`), et
// `generated.ts` en est dérivé. Les calques `weaponChanges` (schéma 24), `equipmentChanges`
...
/**
 * ReplayWeaponChange — UN changement d'arme en main (schéma 24), daté à la milliseconde puis
...
/**
 * ReplayEquipmentChange — UN ramassage ou UNE consommation d'équipement (schéma 25).
 *
...
/**
 * ReplayGroundWeapon — UNE arme au sol, individuelle, bornée par l'OBSERVATION (schéma 26).
 *
...
/**
 * Les trois calques des schémas 24-26 tels que le TRANSPORT les sert : nullables comme tout
