...
make go-api-test-gamefiles  # corpus cartes internal/himap (tag `gamefiles`, EXIGE Halo installe, ~1 h)
...
(`TestBalayageCoquille` seul : 1 246 s, 26 cartes, VERT). Ils sont derrière
