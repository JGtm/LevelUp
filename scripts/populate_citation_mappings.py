...
WEAPON_CITATIONS: list[tuple] = [
    ...
    ("ma40_mastery", "Maîtrise du MA40", "weapon_stat", None, None, "weapon_kills:MA40 AR", None, None, None, None, "high", "Kills avec MA40 AR", True,
     None, "Arme", "Éliminez des Spartans avec le MA40 AR.", "25,50,100,200,500", "UNSC"),
    ("sidekick_mastery", "Maîtrise du Sidekick", "weapon_stat", None, None, "weapon_kills:Mk51 Sidekick", None, None, None, None, "high", "Kills avec MK50 Sidekick", True,
     None, "Arme", "Éliminez des Spartans avec le MK50 Sidekick.", "10,25,50,100,250", "UNSC"),
    ("commando_mastery", "Maîtrise du Commando", "weapon_stat", None, None, "weapon_kills:VK78 Commando", None, None, None, None, "high", "Kills avec VK78 Commando", True,
     None, "Arme", "Éliminez des Spartans avec le VK78 Commando.", "10,25,50,100,250", "UNSC"),
    ("sniper_mastery", "Maîtrise du Sniper", "weapon_stat", None, None, "weapon_kills:S7 Sniper", None, None, None, None, "high", "Kills avec S7 Sniper", True,
     None, "Arme", "Éliminez des Spartans avec le S7 Sniper.", "10,20,40,80,200", "UNSC"),
    ("spnkr_mastery", "Maîtrise du SPNKr", "weapon_stat", None, None, "weapon_kills:M41 SPNKr", None, None, None, None, "high", "Kills avec M41 SPNKr", True,
     None, "Arme", "Éliminez des Spartans avec le M41 SPNKr.", "10,20,40,80,200", "UNSC"),
    ("bulldog_mastery", "Maîtrise du Bulldog", "weapon_stat", None, None, "weapon_kills:CQS48 Bulldog", None, None, None, None, "high", "Kills avec CQS48 Bulldog", True,
     None, "Arme", "Éliminez des Spartans avec le CQS48 Bulldog.", "10,25,50,100,250", "UNSC"),
    ("bandit_mastery", "Maîtrise du Bandit", "weapon_stat", None, None, "weapon_kills:Bandit Evo", None, None, None, None, "high", "Kills avec Bandit EVO", True,
     None, "Arme", "Éliminez des Spartans avec le Bandit EVO.", "10,25,50,100,250", "UNSC"),
    ("stalker_mastery", "Maîtrise du Stalker", "weapon_stat", None, None, "weapon_kills:Stalker Rifle", None, None, None, None, "high", "Kills avec Fusil Stalker", True,
     None, "Arme", "Éliminez des Spartans avec le Fusil Stalker.", "10,25,50,100,250", "Covenant"),
    ("needler_mastery", "Maîtrise de l'Aiguillonneur", "weapon_stat", None, None, "weapon_kills:Needler", None, None, None, None, "high", "Kills avec Aiguillonneur", True,
     None, "Arme", "Éliminez des Spartans avec l'Aiguillonneur.", "10,25,50,100,250", "Covenant"),
    ("energy_sword_mastery", "Maîtrise de l'Épée", "weapon_stat", None, None, "weapon_kills:Energy Sword", None, None, None, None, "high", "Kills avec Épée à énergie", True,
     None, "Arme", "Éliminez des Spartans avec l'Épée à énergie.", "10,20,40,80,200", "Covenant"),
    ("heatwave_mastery", "Maîtrise du Heatwave", "weapon_stat", None, None, "weapon_kills:Heatwave", None, None, None, None, "high", "Kills avec Heatwave", True,
     None, "Arme", "Éliminez des Spartans avec le Heatwave.", "10,25,50,100,250", "Covenant"),
    ("mangler_mastery", "Maîtrise du Mangler", "weapon_stat", None, None, "weapon_kills:Mangler", None, None, None, None, "high", "Kills avec Mangler", True,
     None, "Arme", "Éliminez des Spartans avec le Mangler.", "10,25,50,100,250", "Banished"),
    ("skewer_mastery", "Maîtrise du Skewer", "weapon_stat", None, None, "weapon_kills:Skewer", None, None, None, None, "high", "Kills avec Skewer", True,
     None, "Arme", "Éliminez des Spartans avec le Skewer.", "5,10,20,40,100", "Banished"),
    ("gravity_hammer_mastery", "Maîtrise du Marteau", "weapon_stat", None, None, "weapon_kills:Gravity Hammer", None, None, None, None, "high", "Kills avec Marteau gravitationnel", True,
     None, "Arme", "Éliminez des Spartans avec le Marteau gravitationnel.", "10,20,40,80,200", "Banished"),
    ("cindershot_mastery", "Maîtrise du Cindershot", "weapon_stat", None, None, "weapon_kills:Cindershot", None, None, None, None, "high", "Kills avec Cindershot", True,
     None, "Arme", "Éliminez des Spartans avec le Cindershot.", "10,20,40,80,200", "Banished"),
]
# fmt: on
