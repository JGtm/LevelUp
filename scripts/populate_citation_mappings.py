...
PVP_CITATIONS: list[tuple] = [
    ...
    # ── GROUPE 2 : Arme (2) ────────────────────────────────────────────────
    ("splatter", "Écrasement", "medal", 221693153, None, None, None, None, None, None, "high", "Arme — Médaille Splatter/Écrasement", True,
    ...
    ("driver", "Pilote", "medal", 3169118333, None, None, None, None, None, None, "high", "Arme — Médaille Violence routière", True,
    ...
    ("wraith_destroyer", "Destructeur d'apparitions", "custom", None, None, None, None, None, "compute_wraith_destroyer", None, "high", "Arme — Wraith (Master: 30)", True,
    ...
    ("banshee_destroyer", "Destructeur de banshees", "award", None, None, None, "destroyed_banshee", "vehicle", None, None, "high", "Arme — (Master: 30)", True,
    ...
    ("ghost_destroyer", "Destructeur de ghosts", "award", None, None, None, "destroyed_ghost", "vehicle", None, None, "high", "Arme — (Master: 50)", True,
    ...
    ("mongoose_destroyer", "Destructeur de mongooses", "custom", None, None, None, None, None, "compute_mongoose_destroyer", None, "high", "Arme — Mongoose + Gungoose (Master: 50)", True,
    ...
    ("scorpion_destroyer", "Destructeur de scorpions", "award", None, None, None, "destroyed_scorpion", "vehicle", None, None, "high", "Arme — (Master: 10)", True,
    ...
    ("warthog_destroyer", "Destructeur de warthogs", "custom", None, None, None, None, None, "compute_warthog_destroyer", None, "high", "Arme — Warthog + Rocket Warthog (Master: 50)", True,
    ...
    ("wasp_destroyer", "Destructeur de wasps", "award", None, None, None, "destroyed_wasp", "vehicle", None, None, "high", "Arme — (Master: 30)", True,
